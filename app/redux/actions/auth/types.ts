...
export type AuthActionsType =
  | AuthActionAttemptType
  | AuthActionSuccessType
  | AuthActionFailedType
  | AuthActionGetProfileAttemptType
  | AuthActionGetProfileSuccessType
  | AuthActionGetProfileFailedType
  | AuthActionUpdateProfileAttemptType
  | AuthActionUpdateProfileSuccessType
  | AuthActionUpdateProfileFailedType;
